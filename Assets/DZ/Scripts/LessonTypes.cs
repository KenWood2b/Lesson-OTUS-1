...
namespace Sample
{
    public static class LessonTypes
    {
        ...
        {
            var san = sagenes * 4.445 * 48 + arshins * 48 / 3 * 4.445 + vershoks * 4.445;
            return san / 100;
        ...
        {
            var rad = deg * 0.0174533f + min * 0.000290888f + sec * 4.8481e-6;
            return rad;
        }
        ...
        {
            double SD = Math.Sqrt(Math.Pow(x1 - x2, 2) + Math.Pow(y1 - y2, 2));
            return SD;
        }
        ...
        {
            var T = (hoursArrive * 60 + minutesArrive) - (hoursDepart * 60 + minutesDepart);
            return T;
        }
        ...
        {
            var C = Math.Pow(1 + Convert.ToDouble(percent)/ 100, years) * initialMoney;
            return C;
        }
        ...
        {
            var R = number / 100 % 10 + number / 10 % 10 * 10 + number % 10 * 100;
            return R;
